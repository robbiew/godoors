...
Helpful BBS "door" library in GO for creating linux-based applications (like games and utilities) that run over STDIO, using a terminal program like SyncTerm, MagiTerm, NetRunner or IGterm.
